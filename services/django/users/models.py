...
class UserProfile(models.Model):
    ...
    address_main      = models.TextField(null=True, blank=True)
    ...
    payment_card_provider = models.CharField(max_length=100, null=True, blank=True)
    payment_card_masked_number = models.CharField(max_length=32, null=True, blank=True)
    payment_is_default = models.BooleanField(default=True)
    payment_token_reference = models.CharField(max_length=255, null=True, blank=True)
